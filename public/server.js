...
// Render passe par des proxies (Cloudflare, Render Gateway)
// Sans cela, req.ip = IP interne du proxy, pas du client
// ============================================
app.set('trust proxy', 1);  // Fait confiance au premier proxy (Render)

// ============================================
// SECRET MANAGEMENT — FAIL FAST SI MANQUANT
// ============================================
...
// Hash une seule fois au démarrage pour comparaison timing-safe
